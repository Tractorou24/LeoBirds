export module Engine.Core.Factory;
...
namespace birds::core
{
     ...
     */
    export template <typename BaseType, typename... Args>
    class BaseCreator
    {
    public:
     ...
     * \tparam Args The types of the arguments passed to the constructor of the derived class.
     */
    export template <typename DerivedType, typename BaseType, typename... Args>
     ...
     * \tparam Args The types of the arguments passed to the constructor of the derived class.
     */
    export template <typename Key, typename BaseType, typename... Args>
    class Factory
    {
        using BasePtr = std::unique_ptr<BaseType>;
